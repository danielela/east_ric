/* Timestamp: Thu May 03 10:20:58 PDT 2018*//* Checking the supported browsers */
...
window.v3Lander = {
	...
	createV3Frame: function(win){
		...
		if (typeof(CEAPI_POST_CHAT_SURVEY_DATA) != "undefined" && CEAPI_POST_CHAT_SURVEY_DATA != null) {
			...
			iframesrc = doc.location + '?IFRAME&hostedFileURL=true&siteID=' + 10004593 +
				'&vanityDomain=' + v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain || 'https://verizon.inq.com');
		}
		...
		if (iframesrc==this.hostedFileURL) {
			...
			doc.write(
				...
				+'\t\tsrc="' + v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain || 'https://verizon.inq.com')+'/chatskins/launch/inqChatLaunch10004593.js"><\/script>\n'
				+'</body>\n'
				+'</html>');
			doc.close();
		}
    ...
    loadScript:function(name, useMediaServer) {
        ...
        if (bdy && bdy[0]) {
			...
			if (useMediaServer) {
				srctag.src = v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain || "http://media-lax1.inq.com" || "https://verizon.inq.com") + name;
			} else {
				srctag.src = v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain || "https://verizon.inq.com") + name;
			}
	...
	insertLandingTag:function(){
		v3Lander.loadScript(v3Lander.generatePath("site_10004593_default.js"), true);
     },
			...
			if (document.readyState=="complete" && newIeVersion) {
				...
				try {
					...
					if (isExitChat) {
					    ...
					    if (this.isAtHostedFileURL) {
							document.write('<iframe id="tcBBFrame" src="' + v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain || 'https://verizon.inq.com')+'/tagserver/v3/blank.html" ' +
	...
	v3Lander.hostToPath["WWW.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["MYVPREPAY.VERIZONWIRELESS.COM"]="/ui/mobile/inqChat.html";
 
	v3Lander.hostToPath["ORDERINGLITE.VERIZON.COM"]="/onlineessentials/myaccount/inqChat.html";
 
	v3Lander.hostToPath["SSOAUTH.VERIZON.COM"]="/sso/inqChat.html";
 
	v3Lander.hostToPath["WWW.VERIZON.COM"]="/tc/inqchat.html";
 
	v3Lander.hostToPath["LOGIN.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["NBILLPAY.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["COLLABORATEEXT.VERIZON.COM"]="/aims/html/inqChat.html";
 
	v3Lander.hostToPath["MYVPOSTPAY.VERIZONWIRELESS.COM"]="/ui/hub/inqChat.html";
 
	v3Lander.hostToPath["M.VERIZON.COM"]="/tc/inqchat.html";
 
	v3Lander.hostToPath["ACTIVATE.VERIZON.COM"]="/eActivation/resources/tc/inqChat.html";
 
	v3Lander.hostToPath["CISRESOURCECENTER.VERIZONWIRELESS.COM"]="/content/wsc/inqChat.html";
 
	v3Lander.hostToPath["LOGIN.VZW.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["BUSINESS.VERIZON.COM"]="/MyBusinessAccount/resources/html/inqChat.html";
 
	v3Lander.hostToPath["SIGNIN.VERIZON.COM"]="/sso/inqChat.html";
 
	v3Lander.hostToPath["EBILLPAY.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["WBILLPAY.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["PREORDER.VERIZONWIRELESS.COM"]="/inqchat.html";
 
	v3Lander.hostToPath["SHOP.VERIZON.COM"]="/myaccount/inqChat.html";
	...
	if (window.location.href.indexOf("?BLNK")!=-1) {}
        ...
        var host = (window.v3LanderConfig.vanityDomain || "https://verizon.inq.com").replace(/^https?:\/\//, ""); // Strip the protocol. Domain only.
		...
		var src = (window.v3LanderConfig.vanityDomain || "https://verizon.inq.com") + "/tagserver/cctoken/getToken" + params;
		s.src = src;
		...
		// Need to pass the parameters along...
		var params = window.location.href.replace(/^.*\?/,"?");
		var src = (window.v3LanderConfig.vanityDomain || "https://verizon.inq.com") + "/tagserver/cctokentest/getToken" + params;
		s.src = src;
		document.head.appendChild(s);
	}
