loadHomePageDataLayer = function(json) {
	...
	var condition = "postpaid_homepage";
	var lob = obj.lob;	 
...
var tabletcheck = function() {
    ...
    var check = false;
	(function (a) { if (/Tablet|iPad|iPod/i.test(a)) check = true; })(navigator.userAgent);
...
var getPlatform = function() {
    ...
    if (tabletcheck ()) {platform="tablet" ;}
    else if (mobilecheck ()) {platform="mobile" ;}
    return platform;
